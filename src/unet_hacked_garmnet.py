...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def forward(
        ...
        upsample_size = None
        #print("6666sample.shape",sample.shape)
        ...
        if self.class_embedding is not None:
            ...
            if self.config.class_embeddings_concat:
                ...
                emb = emb + class_emb
        #print("5555sample.shape",sample.shape)
        ...
        if self.encoder_hid_proj is not None and self.config.encoder_hid_dim_type == "text_proj":
            ...
            #print("unet_encoder_hidden_states.shape",encoder_hidden_states.shape)
        #print("unet_encoder_hidden_states.shape",encoder_hidden_states.shape)
        # 2. pre-process
        #print("4444sample.shape",sample.shape)
        sample = self.conv_in(sample)
        #print("3333sample.shape",sample.shape)
        garment_features=[]
